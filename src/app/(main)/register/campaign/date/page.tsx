...
export default function CreateCampaignStepDate() {
    ...
    const handleEndDateSelect = (date?: Date) => {
        ...
        if (isAfter(date, addMonths(startDate, 3))) {
            toast.error("Chiến dịch không được kéo dài quá 3 tháng.");
            return;
        }
        setEndDate(date);
    };
                ...
                <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-20 items-start">
                    <div className="lg:col-span-1 lg:sticky lg:top-20">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed">
                            Hãy đặt lịch cho chiến dịch gây quỹ. Ngày bắt đầu phải từ ngày mai,
                            và chiến dịch không được kéo dài quá 3 tháng.
                        </p>
                    </div>
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        <div className="flex flex-col md:flex-row gap-10 md:gap-16 justify-between items-start">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-gray-600 mb-4">
                                    Ngày kết thúc không thể trước ngày bắt đầu hoặc kéo dài quá 3 tháng.
                                </p>
                                <div className="bg-white border rounded-xl p-5 shadow-sm flex justify-center">
                                    <Calendar
                                        mode="single"
                                        ...
                                        disabled={(date) =>
                                            ...
                                            isAfter(date, addMonths(startDate, 3))
                                        }
                                    />
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-between pt-8 gap-4">
                            ...
                            <Button
                                className={`h-12 px-8 text-base font-semibold w-full sm:w-auto ${!startDate || !endDate
