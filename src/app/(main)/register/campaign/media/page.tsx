          ...
          <div className="lg:col-span-2 pl-8">
            <div className="space-y-6">
              ...
              <label
                ...
                onDrop={handleDrop}
                className="flex flex-col items-center justify-center w-full h-[780px] border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-gray-400 transition bg-white"
              >
                {!hasPreview ? (
            ...
            <div className="flex items-center justify-between mt-10">
              ...
              <Button
                onClick={handleNext}
                disabled={uploading}
                className={`h-12 px-8 text-base font-semibold flex items-center gap-2 ${
                  uploading
