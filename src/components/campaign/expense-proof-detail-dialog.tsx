...
import { CheckCircle, XCircle, Clock, FileText, Calendar, PlayCircle, X, MessageSquare, BookOpen, Layers } from "lucide-react";
        ...
        >
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="flex-1 min-h-0 overflow-y-auto p-8 space-y-6 overscroll-contain">
                {/* Campaign & Phase Info */}
                {expenseProof.request?.campaignPhase && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-start gap-3 p-3 bg-blue-50/50 rounded-lg border border-blue-100/50">
                      ...
                      <div>
                        <div className="text-[10px] font-bold text-blue-600 uppercase tracking-widest mb-0.5">Chiến dịch</div>
                        <div className="text-sm font-bold text-gray-900 leading-tight">
                          {expenseProof.request.campaignPhase.campaign.title}
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-3 bg-orange-50/50 rounded-lg border border-orange-100/50">
                      <div className="p-2 bg-white rounded-full shadow-sm">
                        <Layers className="w-4 h-4 text-orange-600" />
                      </div>
                      <div>
                        <div className="text-[10px] font-bold text-orange-600 uppercase tracking-widest mb-0.5">Giai đoạn</div>
                        <div className="text-sm font-bold text-gray-900 leading-tight">
              ...
              {/* Footer cố định */}
              <div className="flex-shrink-0 px-8 pb-8 pt-4 border-t bg-white dark:bg-slate-900">
