...
import { JoinRequest } from "@/types/api/organization";
    ...
    if (requests.length === 0) {
        return (
            <div className="text-center py-12 bg-white rounded-2xl border border-dashed border-gray-300">
                ...
                <p className="text-gray-500">Hiện không có yêu cầu tham gia nào</p>
            </div>
        );
    }
                ...
                <Card key={request.id} className="overflow-hidden hover:shadow-md transition-shadow">
                    <CardContent className="p-5">
                        <div className="flex items-start justify-between mb-4">
                            ...
                            <Badge variant="outline" className="bg-orange-50 text-[#b55631] border-orange-200">
                                {translateRole(request.member_role)}
                            </Badge>
                        </div>
